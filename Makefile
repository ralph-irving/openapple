...
hdisk.c tm2ho.c floppy.c switches.c slots.c ramworks.c charset.c arithmetic.c atabs.c

OBJS = apple.o cpu.o tables.o memory.o lc.o video.o rect.o ext80col.o mouse.o \
hdisk.o tm2ho.o floppy.o switches.o slots.o ramworks.o charset.o arithmetic.o atabs.o
